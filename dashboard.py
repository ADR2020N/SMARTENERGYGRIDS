...
/* Reduce bottom padding to remove large blank space */
.block-container {
...
# Footer
st.markdown(
    "<div style='text-align:center; margin-top:8px; padding:6px 0; color:#d9d9d9; font-size:11px; background-color:#000000'>NEW Assignment One — AUCA | All rights reserved ©2025, Big Data Analytics</div>",
    unsafe_allow_html=True,
)
